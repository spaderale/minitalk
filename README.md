...
O Minitalk é um projeto da 42 School
 que implementa um sistema de comunicação entre dois processos — um cliente e um servidor — usando apenas sinais UNIX.
...
Bit Shifting (>>, <<)	Move os bits de um valor para acessar posições específicas.
